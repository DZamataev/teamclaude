 ...
 *
 * `x-api-key` or `Authorization: Bearer`, matching the base-URL request path.
 * A browser cannot set either header on a WebSocket handshake, so a browser
 * client cannot authenticate here — deliberately.
